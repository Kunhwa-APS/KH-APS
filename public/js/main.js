...
import { loadVersionsDropdown } from './version-manager.js';
...
window.loadModelWithTracking = loadModelWithTracking;
    ...
    if (captureAfterBtn) {
        captureAfterBtn.onclick = () => {
            if (issueManager) {
                ...
                issueManager.enterMarkupMode(issue ? issue.dbId : 0, issue ? issue.point : null, 'resolve' || 'resolve');
            }
        };
    }
